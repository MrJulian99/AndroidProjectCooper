 ...
 * {@link fragment_movie.OnFragmentInteractionListener} interface
...
public class fragment_movie extends Fragment {
    ...
    public void setOnMovieSelectedListener(OnFragmentInteractionListener mListener){
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        movieRating = (EditText)v.findViewById(R.id.movie_rate);
        movieRating.addTextChangedListener(
                new TextWatcher() {
                    @Override
                    ...
                    public void onTextChanged(CharSequence s, int start, int before, int count) {
                        //CharSequence s is the users input
                        movie.setRate(s.toString());
                    }
